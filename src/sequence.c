...
const uint8_t sequence_2[1+LAYER_N*SEQ_LAYER_SIZE] = {  SEQ_FLAGS_PERIODIC_PIXEL,	//random slow
    ENV_OFFSET_TYPE_RAND|15, ENV_WAVEFORM_PULSE|2, 5,
    ENV_OFFSET_TYPE_RAND|15, ENV_WAVEFORM_PULSE|2, 5,
    ENV_OFFSET_TYPE_RAND|15, ENV_WAVEFORM_PULSE|2, 5,
    ENV_OFFSET_TYPE_RAND|15, ENV_WAVEFORM_PULSE|2, 5,
};
...
uint8_t * sequence_tab[SEQ_N] = {&sequence_1,&sequence_2};
